...
temple.Banner = function(_super) {
    ...
    banner.prototype.setupTimeline = function() {
        ...
        this.mainTimeline.addCallback(this.playTTAnimation.bind(this), "start").to(".keyartWrapper", .5, {
            ...
            opacity: 1
        }, "start+=.8").addCallback(this.playExplode.bind(this), "start+=.8").from(".top_chunks", 2, {
            opacity: 0,
            y: 60,
            rotation: -20,
        ...
        this.trailerInstance.to(".emojiHolder", .5, {
            opacity: 0
        }, "start").to(".top_chunks", .5, {
            opacity: 0,
            y: 60,
            rotation: 20,
            transformOrigin: "50 bottom",
        ...
        this.spriteAnimation($("#logo_break"), this.introTreatmentTL, 970, 250, 4, 7, false);
        this.spriteAnimation($("#explode"), this.explodeTL, 970, 500, 5, 4, false);
    ...
    banner.prototype.moveParallax = function(_posX, _posY) {
        ...
        TweenMax.to(".top_chunks", .5, {
            x: _posX / 20 * -1,
            y: _posY / 20 * -1,
            rotation: .01,
            force3D: true
        });
        TweenMax.to(".bottom_chunks", .5, {
            x: _posX / 30 * -1,
            y: _posY / 30 * -1,
            rotation: .01,
            force3D: true
